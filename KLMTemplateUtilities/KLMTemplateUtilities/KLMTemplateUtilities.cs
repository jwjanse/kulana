...
namespace com.klm.tridion.templating.utilities
{
	public class KLMTemplateUtilities
	{
        private static TemplatingLogger _logger = TemplatingLogger.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        
        public static String ProcessSheet(String strFileName, String sheetName)
        {
